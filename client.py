...
def recivedMsg():
    ...
    while True:
        ...
        if("player1Turn" in message and playerType == "player1"):
            playerTurn = True
            rollButton = Button(gameWindow, text = "rollDice", fg = "black", font = ("ChalkBoard SE", 50), bg = "grey", command = rollDice, width = 20, height = 5)
            rollButton.place(x = screen_width/2-80, y = screen_height/2+250)

        if("player2Turn" in message and playerType == "player2"):
            playerTurn = True
            rollButton = Button(gameWindow, text = "rollDice", fg = "black", font = ("ChalkBoard SE", 50), bg = "grey", command = rollDice, width = 20, height = 5)
            rollButton.place(x = screen_width/2-80, y = screen_height/2+250)
